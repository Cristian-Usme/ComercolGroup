    ...
    <div className={style.offer}>
      ...
      <div className={style.mainOffer}>
        <div className={style.item}>
          <img
            src="https://img.freepik.com/vector-premium/ilustracion-vectorial-concepto-actividad-humana-diaria_1253202-222816.jpg?w=740"
            alt=""
            className={style.img}
          />
          <div className={style.serviceText}>
            <h4 className={style.h4}>Service</h4>
            <p className={style.p}>
